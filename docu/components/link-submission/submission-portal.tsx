    ...
    return (
        <>
            ...
            {mounted && createPortal(
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 data-[state=open]:animate-in data-[state=closed]:animate-out" data-state={isOpen ?  "open" : "closed"}>
                    <div className="rounded-xl bg-card p-8 shadow-lg border border-input text-card-foreground mx-4 w-full max-w-md" ref={menuRef}>
